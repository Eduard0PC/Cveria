...
export default function ResultsPage() {
  ...
  return (
    <main className="min-h-screen px-6 py-10 flex flex-col items-center justify-center bg-white dark:bg-black transition-colors duration-300">
      <h1 className="text-3xl sm:text-5xl text-center font-bold mt-20 px-2 text-black dark:text-white">
      ...
      {porcentaje !== null && (
        <div className="w-40 h-40 sm:w-50 sm:h-50 lg:w-100 lg:h-100 my-10">
          <CircularProgressbar
            ...
            styles={buildStyles({
              textSize: '16px',
              pathColor: `rgba(${porcentaje >= 50 ? 34 : 59}, ${porcentaje >= 50 ? 197 : 130}, ${porcentaje >= 50 ? 94 : 246}, ${porcentaje / 100})`,
              textColor: '',
      ...
      {resultado ? (
        <pre className="bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-100 p-4 rounded-lg whitespace-pre-wrap max-w-4xl w-full shadow-md">
          {resultado}
        </pre>
      ) : (
